...
pub fn build(b: *std.Build) void {
    ...
    exe_mod.addImport("raven_lib", lib_mod);
    ...
    const smoke_cmd = b.addSystemCommand(&.{ "bash", "scripts/integration-smoke.sh" });
    smoke_cmd.step.dependOn(b.getInstallStep());

    const smoke_step = b.step("smoke", "Run end-to-end smoke test");
